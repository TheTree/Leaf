<footer>
    <nav class="navbar-fixed-bottom" role="navigation">
        <span class="pull-left">
            <small><a href="#legalStuff" role="button" class="btn btn-primary" data-toggle="modal">Leaf</a></small>
        </span>
    </nav>
</footer>
</body>
<div id="legalStuff" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="legalStuff" aria-hidden="true">
