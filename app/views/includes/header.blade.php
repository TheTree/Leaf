		...
		<div class="collapse navbar-collapse navbar-leaf">
			<nav>
				<ul class="nav navbar-nav">
					<li class=""><a href="{{ URL::to('news') }}">News</a></li>
					<li class=""><a href="{{ URL::to('csr_leaderboards') }}">CSR Leaderboards</a></li>
					<li class=""><a href="{{ URL::to('top_ten') }}">Top Ten</a></li>
					<li class=""><a href="{{ URL::to('compare') }}">Compare</a></li>
